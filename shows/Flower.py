...
class Flower(object):
	...
	def next_frame(self):
		...
		while (True):
			...
			# Change it up!
			if oneIn(4):
				self.color_inc = inc(self.color_inc,2,20,40)
			if oneIn(40):
